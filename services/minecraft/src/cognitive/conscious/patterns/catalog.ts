...
export const PATTERN_CATALOG: PatternCard[] = [
  ...
  },
  {
    ...
    whenToUse: ['collectBlocks fails to find a requested type.', 'Requested block has known wall or state variants.'],
  },
  {
    code: [
      '// Turn A',
    ...
    whenToUse: ['Action parameters depend on query results.', 'The world may change while planning.'],
  },
  {
    code: [
    ...
    whenToUse: ['Repeated no-action turns with similar return values.', 'noActionBudget.remaining is 0 or close to 0.'],
  },
  {
    code: [
  ...
  },
  {
    ...
    whenToUse: ['Control actions can fail due to environment uncertainty.', 'Task needs iterative adaptation.'],
  },
]
