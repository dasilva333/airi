...
function createMineflayerStub() {
  const blocks = new Map<string, any>([
    [
      '1,64,0',
      { boundingBox: 'block', diggable: true, name: 'coal_ore', position: new Vec3(1, 64, 0), transparent: false },
    ],
    [
      '2,64,0',
      { boundingBox: 'block', diggable: true, name: 'stone', position: new Vec3(2, 64, 0), transparent: false },
    ],
    [
      '3,64,0',
      { boundingBox: 'block', diggable: true, name: 'coal_ore', position: new Vec3(3, 64, 0), transparent: false },
    ],
    [
      '4,64,0',
      {
