...
const setBounds = defineInvokeEventa<void, Parameters<BrowserWindow['setBounds']>>(
  'eventa:invoke:electron:window:set-bounds',
)
const setIgnoreMouseEvents = defineInvokeEventa<void, [boolean, { forward: boolean }]>(
  'eventa:invoke:electron:window:set-ignore-mouse-events',
)
const setVibrancy = defineInvokeEventa<void, Parameters<BrowserWindow['setVibrancy']> | [null]>(
  'eventa:invoke:electron:window:set-vibrancy',
)
const setBackgroundMaterial = defineInvokeEventa<void, Parameters<BrowserWindow['setBackgroundMaterial']>>(
