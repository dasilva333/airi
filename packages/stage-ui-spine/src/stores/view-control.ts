...
export const controlConfig: Record<SupportedControl, ControlConfig> = {
  scale: { default: 1, format: formatToPercent, max: 3, min: 0.01, step: 0.01 },
  x: { default: 0, format: formatPercentD1, max: 500, min: -500, step: 0.1 },
  y: { default: 0, format: formatPercentD1, max: 500, min: -500, step: 0.1 },
}
