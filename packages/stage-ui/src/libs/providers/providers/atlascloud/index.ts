...
export const providerAtlasCloud = defineProvider<AtlasCloudConfig>({
  ...
  order: 5,
  name: 'Atlas Cloud',
  nameLocalize: ({ t }) => t('settings.pages.providers.provider.atlascloud.title') || 'Atlas Cloud',
  description: 'api.atlascloud.ai',
  descriptionLocalize: ({ t }) => t('settings.pages.providers.provider.atlascloud.description') || 'api.atlascloud.ai',
  tasks: ['chat'],
  icon: 'i-lobe-icons:openai',
  business: () => ({
    pricing: 'paid',
    deployment: 'cloud',
    consoleUrl: 'https://atlascloud.ai',
  }),
