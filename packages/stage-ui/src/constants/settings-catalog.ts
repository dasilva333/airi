...
export const SETTINGS_CATALOG_ITEMS: CatalogNodeItem[] = [
  ...
  },
  {
    ...
    descriptionKey: 'settings.pages.card.description',
    description: 'Edit character details, prompt directives, acting expressions, and connected modules.',
    glyph: '編',
    clusterGroup: 'CHARACTER & SCENE 姿',
    route: '/settings/airi-card/edit',
  ...
  {
    id: 'models-explore',
    label: 'Discover Avatars',
    shortLabel: 'Discover',
    titleKey: 'settings.pages.models.explore.title',
    descriptionKey: 'settings.pages.models.explore.description',
    description: 'Curated marketplaces and community archives to find and download free 2D and 3D avatars and motions.',
    glyph: '探',
    clusterGroup: 'CHARACTER & SCENE 姿',
    route: '/settings/models/explore',
    icon: 'i-solar:planet-3-bold-duotone',
    order: 1,
    parentId: 'area-models',
    kind: 'page',
  },
  {
    id: 'area-scene',
  ...
  },
  {
    ...
    description: 'Application version, release changelog, open source credits, and community links.',
    glyph: '誌',
    clusterGroup: 'SYSTEM 系',
  ...
  },
  {
    ...
    description: 'Cloudflare account, workers edge subdomain, CORS proxy, and key vault',
    glyph: '網',
    clusterGroup: 'BRIDGES & SYNC 網',
    route: '/settings/modules/cloudflare',
  ...
  {
    id: 'prov-moondream-local',
    label: 'Moondream2 VLM (Local, WebGPU)',
    shortLabel: 'Moondream2',
    ...
    glyph: '視',
    clusterGroup: 'LOCAL 端',
    route: '/settings/providers/chat/moondream-local',
    icon: 'i-solar:eye-scan-bold-duotone',
    order: 2,
    parentId: 'prov-cat-vision',
    kind: 'page',
    keywords: ['moondream', 'moondream2', 'vlm', 'vision', 'local', 'webgpu', 'image to text', 'vlm model'],
  },
  {
