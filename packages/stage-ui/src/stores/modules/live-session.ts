  ...
  const cleanSchema = (obj: any) => {
    ...
    if (obj.properties) {
      ...
      for (const [key, prop] of Object.entries(obj.properties)) {
        ...
        // If the parameter is nullable/optional, we remove it from the required list
        // so Gemini doesn't complain about invalid schema formats, representing it as optional.
        if (isNullable) {
