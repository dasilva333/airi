...
const providerId = 'deepgram-transcription'
      ...
      <ProviderSettingsContainer class="w-full md:w-[40%]">
        ...
        >
          ...
          <FieldInput
            ...
            :description="apiKey && baseUrl ? 'Enter model name manually, or wait for models to load...' : 'Enter the transcription model name (e.g., nova-3)'"
