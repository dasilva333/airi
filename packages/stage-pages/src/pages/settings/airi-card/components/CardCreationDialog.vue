...
function initializeCard(): Card {
  ...
  const legacyPreferredBackgroundId = (airiExt?.modules as { preferredBackgroundId?: string } | undefined)?.preferredBackgroundId
  const activeBg = airiExt?.modules?.activeBackgroundId || legacyPreferredBackgroundId
