  ...
  <PopoverRoot v-model:open="isOpen">
    ...
    <PopoverPortal>
      <PopoverContent
        ...
        class="data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 z-[9999] max-w-[calc(100vw-24px)] w-72 flex flex-col border border-neutral-200/60 rounded-2xl bg-white/95 p-2.5 shadow-2xl backdrop-blur-2xl duration-200 dark:border-neutral-800/80 dark:bg-neutral-950/95"
      >
        <!-- Header -->
