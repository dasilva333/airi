...
const mapping = {
  ...
  'airi-app-entry-wiring': [
    ...
    { path: 'docs/design-stage-ui-context-bridge-control-island.md', note: 'Control Island / Stage UI context bridge architecture.' },
  ...
  'airi-binary-safety': [
    ...
    { path: 'docs/arch-indexeddb-storage.md', note: 'IndexedDB storage architecture.' },
  ],
  ...
  'airi-data-persistence': [
    ...
    { path: 'docs/arch-indexeddb-storage.md', note: 'IndexedDB storage architecture.' },
    { path: 'docs/design-text-journal-storage.md', note: 'Text journal storage design.' },
    { path: 'docs/design-image-journal-storage.md', note: 'Image journal storage design.' },
  ...
  'airi-memory-systems': [
    ...
    { path: 'docs/arch-memory-system-overview.md', note: 'Memory system architecture overview.' },
    { path: 'docs/arch-long-term-memory-journal.md', note: 'Long-term memory journal architecture.' },
    { path: 'docs/arch-short-term-memory-summaries.md', note: 'Short-term memory summaries architecture.' },
    { path: 'docs/design-text-journal-storage.md', note: 'Text journal storage design.' },
    { path: 'docs/design-image-journal-storage.md', note: 'Image journal storage design.' },
  ...
  'airi-memory-retrieval-engine': [
    ...
    { path: 'docs/design-semantic-search-browser-native.md', note: 'Browser-native semantic search design.' },
    { path: 'docs/blueprint-semantic-search-integration.md', note: 'Semantic search integration blueprint.' },
    { path: 'docs/rosetta-stone.md', note: 'Canonical concept-to-path index; §9 memory-systems canonical path index.' },
  ],
  ...
  'airi-character-rendering': [
    { path: 'docs/design-vrm-animation-ecosystem.md', note: 'VRM animation ecosystem design.' },
    { path: 'docs/arch-live2d-wasm-optimization.md', note: 'Live2D WASM optimization architecture.' },
    { path: 'docs/design-act-token-expression-system.md', note: 'ACT token expression system design.' },
    { path: 'docs/research-vrm-cloth-interaction.md', note: 'VRM cloth interaction deep dive.' },
    { path: 'docs/research-mmd-issues-and-regressions.md', note: 'MMD issues and regressions.' },
    { path: 'docs/design-spine-model.md', note: 'Spine model design.' },
    { path: 'docs/rosetta-stone.md', note: 'Canonical concept-to-path index; §16 binary-proxy lesson.' },
  ],
  'airi-live2d-dsl-interpreter': [
    { path: 'docs/design-live2d-dsl-interpreter-spec.md', note: 'Formal specification for the Live2D Scripting DSL instruction set.' },
    { path: 'docs/handoff-live2d-dsl-phase2.md', note: 'Phase 2 implementation handoff (instruction dispatch, test cases).' },
    { path: 'docs/design-live2d-multimoc-changecos.md', note: 'Multi-moc3 costume switching (change_cos) design.' },
    { path: 'docs/design-live2d-dsl-test-cases.md', note: 'DSL test cases handoff.' },
    { path: 'docs/design-live2d-change-cos-challenge.md', note: 'change_cos dependency challenge.' },
    { path: 'docs/research-live2d-special-sauce.md', note: 'Live2D special sauce insights.' },
  ...
  'airi-modular-outfits-system': [
    ...
    { path: 'docs/design-live2d-multimoc-changecos.md', note: 'Live2D multi-moc3 change_cos design.' },
    { path: 'docs/design-modular-outfits-system.md', note: 'Modular outfits system design.' },
    { path: 'docs/design-airi-card.md', note: 'AIRI card design (packages, manifestations, visual assets).' },
  ],
  'airi-generative-motion-vrma': [
    ...
    { path: 'docs/text-to-motion.md', note: 'Text-to-motion research reference.' },
    { path: 'docs/mocap.md', note: 'Mocap research reference.' },
    { path: 'docs/design-vrm-animation-ecosystem.md', note: 'VRM animation ecosystem design.' },
    { path: 'docs/proposal-emotion-motion-library.md', note: 'Emotion motion library proposal.' },
  ],
  'airi-vrm-vhack-studio': [
    { path: 'docs/design-vhack-studio.md', note: 'V-HACK DevTools design document.' },
    { path: 'docs/research-vrm-cloth-interaction.md', note: 'VRM cloth interaction deep dive.' },
    { path: 'docs/rosetta-stone.md', note: 'Canonical concept-to-path index; §16 binary-proxy lesson.' },
  ],
  'airi-scenes-backgrounds': [
    { path: 'docs/design-scenes-and-backgrounds-system.md', note: 'Scenes and backgrounds system design.' },
    { path: 'docs/design-image-journal-storage.md', note: 'Image journal storage design.' },
    { path: 'docs/project-artistry-porting-report.md', note: 'Artistry porting report.' },
    { path: 'docs/rosetta-stone.md', note: 'Canonical concept-to-path index; §16 toRaw/binary lesson.' },
  ],
  'airi-caption-subsystem': [
    { path: 'docs/design-head-tethered-captions.md', note: 'Canonical design for head-tethered captions vs windowed captions.' },
    { path: 'docs/design-live2d-caption.md', note: 'Live2D caption pipeline design (motion Text/Language fields).' },
    { path: 'docs/design-captions-widget-system.md', note: 'Captions widget system.' },
  ...
  'airi-model-customizer': [
    { path: 'docs/design-model-customizer.md', note: 'ModelCustomizer.vue separation of concerns, settings panel adoption matrix.' },
    ...
    { path: 'docs/design-stage-ui-context-bridge-control-island.md', note: 'Stage UI context bridge / control island architecture.' },
  ...
  'airi-chatbox-ui-surface': [
    { path: 'docs/design-tamagotchi-chatbox-ux-improvements.md', note: 'Tamagotchi chatbox UX improvements design.' },
  ...
  'airi-artistry-comfyui-widgets': [
    { path: 'docs/design-comfyui-image-generation-widget.md', note: 'ComfyUI image generation widget design.' },
    { path: 'docs/arch-comfyui-native-api-engine.md', note: 'ComfyUI native API engine architecture.' },
    { path: 'docs/design-flux-grid-slice-image-generation.md', note: 'Flux grid slice image generation design.' },
    { path: 'docs/project-artistry-porting-report.md', note: 'Artistry porting report.' },
    { path: 'docs/design-ideogram-4-schema.md', note: 'Ideogram 4 schema.' },
  ...
  'airi-proactivity-sensory-telemetry': [
    { path: 'docs/design-proactivity-heartbeats-engine.md', note: 'Proactivity heartbeats engine design (5-phase pipeline).' },
    { path: 'docs/arch-chat-stt-proactivity-pipelines.md', note: 'Chat/STT/proactivity pipelines architecture.' },
    ...
    { path: 'docs/design-director-producer-roles.md', note: 'Director/producer roles document.' },
  ...
  'airi-attention-ecology-vision': [
    ...
    { path: 'docs/design-vision-system-support.md', note: 'Vision system support (localized architecture copy).' },
    { path: 'docs/design-vision-api-cost-analysis.md', note: 'Vision API cost analysis.' },
  ...
  'airi-prefix-cache-alignment': [
    ...
    { path: 'docs/design-token-usage-metrics.md', note: 'Token usage metrics.' },
  ...
  'airi-discord-integration': [
    ...
    { path: 'docs/design-discord-bot-integration.md', note: 'Original Discord bot integration design.' },
    ...
    { path: 'docs/design-cloud-relay.md', note: 'Cloud relay architecture (Discord Edge deployment).' },
    { path: 'docs/design-telegram-integration.md', note: 'Telegram project design.' },
  ...
  'airi-provider-store-instances': [
    ...
    { path: 'docs/provider-catalog.md', note: 'Provider catalog reference.' },
    { path: 'docs/arch-provider-store-current-structure.md', note: 'Provider store current structure architecture.' },
  ...
  'airi-cloud-relay-infrastructure': [
    { path: 'docs/design-cloud-relay.md', note: 'Master document for Cloud Relay Architecture.' },
    ...
    { path: 'docs/arch-gateway-security-hardening.md', note: 'Gateway security hardening architecture.' },
  ...
  'airi-local-inference-engines': [
    ...
    { path: 'docs/research-moss-tts-nano-report.md', note: 'MOSS TTS nano research report.' },
  ],
  'airi-audio-pipeline': [
    { path: 'docs/feat-audio-studio.md', note: 'Audio studio feature spec (VoiceProfiles, UST).' },
    { path: 'docs/design-openai-compatible-tts.md', note: 'OpenAI-compatible TTS.' },
    { path: 'docs/blueprint-tts-universal-speech-transformer.md', note: 'TTS universal speech transformer blueprint.' },
    { path: 'docs/blueprint-aws-polly-integration.md', note: 'AWS Polly integration blueprint.' },
    ...
    { path: 'docs/tts.md', note: 'TTS research reference.' },
    { path: 'docs/lipsync.md', note: 'Lipsync research reference.' },
  ],
  'airi-gemini-live-api': [
    { path: 'docs/design-gemini-live-api-integration.md', note: 'Canonical Gemini Live API integration design.' },
    { path: 'docs/project-multimodal-audio-transport.md', note: 'Multimodal audio transport project.' },
    { path: 'docs/arch-chat-stt-proactivity-pipelines.md', note: 'Chat/STT/proactivity pipelines architecture.' },
  ],
  'airi-mcp-integration': [
    { path: 'docs/arch-mcp-integration.md', note: 'MCP integration architecture.' },
    { path: 'docs/research-open-apis-and-mcp-servers.md', note: 'Finding open APIs, MCP servers, and plugins.' },
    { path: 'docs/rosetta-stone.md', note: 'Canonical concept-to-path index; §1 eventa contract registry.' },
  ],
  // ── Onboarding & Cards ──────────────────────────────────────────────────────
  'airi-card-schema': [
    { path: 'docs/design-airi-card.md', note: 'AIRI Package Spec v2, upstream ZIP packaging, ecosystem interoperability.' },
    { path: 'docs/design-character-card-import-export.md', note: 'Character card import/export design.' },
    ...
    { path: 'docs/design-starter-character-gold-standard.md', note: 'Starter character gold standard.' },
  ],
  'airi-card-editor-wizard': [
    ...
    { path: 'docs/project-animadex-wizard-pending-items.md', note: 'AnimaDex wizard pending items.' },
    { path: 'docs/proposal-default-cards-revamp.md', note: 'Default cards revamp proposal.' },
    { path: 'docs/design-airi-card.md', note: 'AIRI card design spec.' },
  ...
  'airi-dating-sim-engine': [
    { path: 'docs/design-dating-sim-gamestate-mechanics.md', note: 'Dating sim gamestate mechanics.' },
    { path: 'docs/design-dating-sim-intimacy-spec.md', note: 'Dating sim intimacy spec.' },
    { path: 'docs/design-director-producer-roles.md', note: 'Director/producer roles document.' },
    { path: 'docs/content/en/docs/showcase/07-producer-subsystem.md', note: 'Producer subsystem showcase.' },
    { path: 'docs/rosetta-stone.md', note: 'Canonical concept-to-path index; §13 BroadcastChannel registry.' },
  ],
  'airi-prompt-builder-engine': [
    { path: 'docs/design-prompt-crafting-catalog.md', note: 'Prompt crafting catalog.' },
    ...
    { path: 'docs/design-character-configurable-llm.md', note: 'Character-configurable LLM design.' },
    { path: 'docs/design-director-producer-roles.md', note: 'Director/producer roles document.' },
  ...
  'airi-roadmap-upstream-research': [
    ...
    { path: 'docs/research-fork-harvest-report.md', note: 'Fork harvest report.' },
    { path: 'docs/research-forks-ecosystem.md', note: 'Forks ecosystem.' },
