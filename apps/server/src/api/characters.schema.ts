...
const AvatarModelTypeSchema = union([literal('vrm'), literal('live2d')])
...
export const CreateCharacterSchema = object({
  avatarModels: optional(
    array(
      createInsertSchema(schema.avatarModel, {
  ...
  capabilities: optional(
    array(
      createInsertSchema(schema.characterCapabilities, {
        characterId: optional(string()),
  ...
  cover: optional(
    createInsertSchema(schema.characterCovers, {
      characterId: optional(string()),
    }),
  ),
  i18n: optional(
    array(
      createInsertSchema(schema.characterI18n, {
        characterId: optional(string()),
  ...
  prompts: optional(
    array(
      createInsertSchema(schema.characterPrompts, {
        characterId: optional(string()),
      }),
    ),
  ),
