...
export const characterCovers = pgTable('character_covers', {
...
export const avatarModel = pgTable('avatar_model', {
  characterId: text('character_id')
    .notNull()
    .references(() => character.id, { onDelete: 'cascade' }),
...
export const characterI18n = pgTable('character_i18n', {
  characterId: text('character_id')
    .notNull()
    .references(() => character.id, { onDelete: 'cascade' }),
...
export const characterCoversRelations = relations(characterCovers, ({ one }) => ({
...
export const avatarModelRelations = relations(avatarModel, ({ one }) => ({
  character: one(character, {
...
export const characterCapabilitiesRelations = relations(characterCapabilities, ({ one }) => ({
  character: one(character, {
...
export const characterI18nRelations = relations(characterI18n, ({ one }) => ({
  character: one(character, {
